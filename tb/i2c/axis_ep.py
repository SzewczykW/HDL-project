...
# skip_asserts = True will skip the assertions in the AXIStreamSink and AXIStreamSource classes
skip_asserts = False

class AXIStreamFrame(object):
    """ Class to represent an AXI4-Stream frame
    """
    ...
    def __init__(self, data=b'', keep=None, id=None, dest=None, user=None, last_cycle_user=None):
        ...
        Args:
            ...
            dest: dest signal
            user: user signal
            last_cycle_user: user signal for the last cycle

        Returns:
            New AXIStreamFrame object
        """
        self.B = 0
        self.N = 8
        self.M = 1
    ...
    def build(self):
        """ Build the frame from the data

        Returns:
            Tuple of (tdata, tkeep, tid, tdest, tuser)
        """
    ...
    def parse(self, tdata, tkeep, tid, tdest, tuser):
        """ Parse the frame from the signals
    ...
    def __eq__(self, other):
        """ Compare two AXIStreamFrame objects

        Args:
            other: AXIStreamFrame object to compare with
        Returns:
...
class AXIStreamSource(object):
    """ Class to create an AXI4-Stream source interface
    """
    ...
    def send(self, frame):
        ...
        Args:
            frame: AXIStreamFrame object to send
    ...
    def create_logic(self,
        ...
        Returns:
            myhdl instances() for the source logic
        """
...
class AXIStreamSink(object):
    """ Class to create an AXI4-Stream sink interface
    """
    ...
    def create_logic(self,
        ...
        Returns:
            myhdl instances() for the sink logic
        """
