...
class I2CMaster(object):
    ...
    def create_logic(self,
        ...
        Args:
            clk: clock signal
            rst: reset signal
            scl_i: scl input signal
            scl_o: scl output signal
            scl_t: scl tri-state signal
            sda_i: sda input signal
            sda_o: sda output signal
            sda_t: sda tri-state signal
            prescale: prescale value for clock
